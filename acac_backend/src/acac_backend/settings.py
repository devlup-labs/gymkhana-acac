"""
Django settings for acac_backend project.
...
ROOT_URLCONF = 'acac_backend.urls'
...
STATICFILES_FINDERS = [
    ...
    'acac_backend.utils.VueFilesFinder',
...
WSGI_APPLICATION = 'acac_backend.wsgi.application'
...
GRAPHENE = {
    'SCHEMA': 'acac_backend.schema.schema',
    'SCHEMA_INDENT': 2,
